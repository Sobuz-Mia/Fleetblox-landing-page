  ...
  const animationItems = [
    {
      ...
      content:
        "Unify operations whether you’re managing luxury cars, utility vans, EVs, or specialized vehicles. Track availability, monitor vehicle health, and streamline handoffs all from one intelligent dashboard, in real-time.",
      image: `/images/industries/one-network-1.svg`,
    },
    {
      title: "Cut the Cost of Non- Compliance",
      content:
        "Avoid expensive delays and operations with Fleetblox. Our system automates critical compliance processes, including VIN verification, entry inspections, registration monitoring, and document storage, all in one place. Manage every deadline, keep your roads ready fleet, and reduce costs with ease.",
  ...
  const Deals = [
    {
      ...
      content:
        "Bring together all elements of your fleet business—vehicles, personnel, locations, and information—into a single intelligent platform that simplifies management and unlocks total visibility.",
...

    {
      ...
      content:
        "Maintain every vehicle and crew operating at top condition with smart diagnostics, scheduled checks, and synchronized tasks in the cloud—maximizing uptime and value.",
      image: "/images/industries/ecosystem.png",
    },
    {
      title: "Expansion-Ready",
      content:
        "Scale on a malleable infrastructure that adjusts according to your business model. Growing into new territories or introducing new services, scale with zero drag and complete autonomy.",
        ...
        <div className="lg:max-w-[calc(100vw-30px)] xxl:max-w-[1440px] mx-auto w-full flex flex-col px-5 lg:flex-row items-center justify-between">
          <div className="lg:pl-[130px] max-w-[700px] w-full">
            ...
            <h1 className="text-[#04082C] text-[36px] lg:text-[50px] font-bold leading-[1.1] w-full">
              Operate Smarter, Expand Faster- All in One Platform
            </h1>
            <p className="text-[#333] text-[16px] leading-6 mt-[10px] lg:mt-4 mb-5 font-openSans">
              Fleetblox brings your entire ecosystem together and enables you to
              customize intricate business models with and grow with ease from
              one place.
            </p>
            {/* <Link
      ...
      <section className=" mx-auto w-full mt-[60px] lg:mt-[100px] px-5">
        <div className="max-w-[840px] mx-auto w-full text-center">
          ...
          <p className="text-[#333] text-[16px] leading-6 font-openSans">
            Expand effortlessly with an infrastructure designed for fleet-first
            growth
          </p>
        </div>
        <Deal Deals={Deals} />
          ...
          <div className="flex items-center justify-center">
            <div className="max-w-[500px] w-full">
              <h3 className="text-[#04082C] leading-[100%] font-bold text-[36px] font-montserrat">
                Turn Budgeting Into a Profit Strategy
              </h3>
              <p className="text-[#333333] mt-4 text-[16px] leading-[150%] font-openSans text-justify">
                Fleetblox enables easy budgeting across all your locations, with
                personalized expense categories and real-time budget tracking.
                Set dynamic budgets for each location, receive smart alerts for
                potential overages, and leverage data-driven insights to
                optimize spending and boost profitability in your entire fleet
                business.
              </p>
            </div>
          </div>
      ...
      <section className="bg-[#FAFAFF] w-full mt-[60px] lg:mt-[100px] py-12">
        <div className="max-w-[1200px] mx-auto px-5 grid grid-cols-1 lg:grid-cols-2 items-center gap-6 lg:gap-10">
          ...
          <div className="flex items-center justify-center">
            <div className="max-w-[500px] w-full">
              <h3 className="text-[#04082C] leading-[100%] font-bold text-[36px] font-montserrat">
                Keep Assets Road-Ready with Scheduled Inspections
              </h3>
              <p className="text-[#333333] mt-4 text-[16px] leading-[150%] font-openSans">
                Assign tasks to technicians, maintain vehicles in prime
                condition. Schedule and track routine maintenance inspections,
                catch issues early, and prevent costly downtime. Keep the value
                of your fleet intact and road-ready at all times
              </p>
            </div>
          </div>
        </div>
