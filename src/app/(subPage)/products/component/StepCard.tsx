...
const StepCard = ({
  ...
  console.log("Received Stepper:", stepper);
  return (
    <div
    ...
    >
      <div className="bg-white absolute z-50 rounded-[24px] py-10 px-[30px] flex flex-col gap-[10px] w-full h-full">
        {/* <div className="max-w-[44px] max-h-[44px] w-full mx-auto mb-2 h-full border-2 border-[#0336BC] rounded-[60px] p-1 lg:hidden flex items-center justify-center text-[#0336BC] font-openSans text-[22px] font-bold">
          {stepper}
        </div> */}
