...
const StarterFleetPage = () => {
    ...
    return (
        <>
            ...
            <div className={`fixed bottom-6 right-4 z-[1000] transition-all duration-300 transform ${showMobileCta ? 'translate-y-0 opacity-100 scale-100' : 'translate-y-20 opacity-0 scale-95'} lg:hidden`}>
                <Link href="/getting-started">
                    <button className="bg-[#2D65F2] hover:bg-[#0336BC] text-white rounded-full w-14 h-14 flex items-center justify-center shadow-lg hover:shadow-xl transition-all duration-300 active:scale-95" aria-label="Get started">
            ...
            <section className="bg-[#FAFAFF] pt-[60px] sm:pt-[80px] md:pt-[100px] pb-[20px] sm:pb-[30px] overflow-hidden relative">
                <div className="max-w-[1200px] mx-auto px-4 sm:px-5 flex flex-col items-center py-[60px] sm:py-[80px] md:py-[100px] lg:py-[120px] text-center relative z-50">
                    ...
                    <Link aria-label="Get started with FleetBlox" href="/getting-started" className="w-full sm:w-auto">
                        <button className="transition-all bg-[#2D65F2] hover:bg-[#0336BC] font-openSans text-white-primary text-white duration-300 flex items-center px-4 py-3 text-[14px] md:text-base font-bold rounded-md group justify-center w-full sm:w-auto sm:min-w-[168.72px] hover:sm:min-w-[190.72px] shadow-sm hover:shadow-md">
            ...
            <section className="py-12 sm:py-16 md:py-20 lg:py-12 max-w-[1200px] mx-auto w-full flex flex-col-reverse xl:flex-row items-stretch gap-8 sm:gap-10 md:gap-12 relative px-4 sm:px-5">
                ...
                <div className="flex-1 w-full flex flex-col justify-center text-center xl:text-left">
                    ...
                    <p className="text-[#7D7D7D] text-sm sm:text-base leading-6 font-openSans mb-6 sm:mb-8 lg:mb-12 max-w-[90%] sm:max-w-none mx-auto xl:mx-0">
                        Easily verify your fleets with a simple compatibility check and securely connect through your OEM account to start streaming real-time data for monitoring vehicle health, performance, and key metrics—without the need for any installations.
                    </p>                        <div className="grid grid-cols-1 gap-4 sm:gap-5 justify-items-center xl:justify-items-start">
                        {[
                            { title: "Compatibility check" },
                            { title: "Connect through OEM" },
                            { title: "Streaming real-time data" },
                        ]?.map((data, index) => (
                            <div key={index} className="flex relative max-w-[480px] w-full group">
            ...
            <section className="py-12 sm:py-16 md:py-20 max-w-[1300px] mx-auto flex flex-col w-full px-4 sm:px-5">
                <div className="max-w-[900px] mx-auto w-full text-center">
                    <p className="text-[#0336BC] font-openSans mb-1 sm:mb-2 font-bold text-base sm:text-lg">Instant vehicle profile</p>
                    ...
                    <p className="text-[#7D7D7D] text-[14px] sm:text-[15px] md:text-[16px] leading-[1.6] sm:leading-6 font-openSans max-w-[95%] mx-auto">
                        Build detailed digital profiles for all vehicles instantly via VIN scanning and auto-extracting of vehicle technical details like
                        <span className="hidden md:inline"><br /></span>
                        <span className="md:hidden"> </span>
                        make, model, drivetrain, engine type, and more quickly turning your fleet into an entirely searchable, data-rich asset.
                    </p>
                </div>
            ...
            <section className="py-12 sm:py-16 md:py-20 bg-[#FAFAFF] mx-auto w-full px-4 sm:px-5">
                <div className="max-w-[1200px] flex flex-col lg:flex-row items-center gap-6 sm:gap-8 lg:gap-10 justify-between mx-auto w-full">
                    ...
                    <div className="w-full lg:w-1/2 flex flex-col justify-center text-center lg:text-left order-1 lg:order-2">
                        <p className="text-[#0336BC] font-openSans font-[700] text-base sm:text-lg">Multi-powertrain integration</p>
                        <h3 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl text-[#04082C] font-bold leading-tight mt-2 mb-3 sm:mb-4">
                        ...
                        <p className="text-[#7D7D7D] text-sm sm:text-base leading-6 font-openSans mb-6 sm:mb-8 lg:mb-12 max-w-[90%] mx-auto lg:mx-0">
                            FleetBlox connects to vehicles with any type of powertrain - combustion, hybrid, or electric - and enables real-time insights into performance, health, and energy use.
                        </p>
                        <div className="grid grid-cols-1 gap-4 sm:gap-5 justify-items-center lg:justify-items-start">
                            {[
                                ...
                                <div key={index} className="flex relative max-w-[300px] w-full group">
                                    <div className="absolute top-2 left-2 right-2 z-10 rounded-2xl bg-[rgba(0,0,0,0.08)] blur-md h-[calc(100%+8px)] transition-all duration-300 group-hover:bg-[rgba(0,0,0,0.12)]"></div>
                                    <div className="z-50 p-4 sm:p-5 bg-white w-full rounded-xl flex items-center gap-3 sm:gap-4 transition-transform duration-300 group-hover:translate-y-[-2px]">
                                        <div className="flex-shrink-0 transition-transform duration-300 group-hover:scale-110">{data?.icon}</div>
                                        <div className="text-left">
...
const InstantControlIcon = () => {
    return (
        <svg width="32" height="33" viewBox="0 0 32 33" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M6 4.89453C5.44772 4.89453 5 5.34225 5 5.89453V20.8945C5 21.4468 5.44772 21.8945 6 21.8945H26C26.5523 21.8945 27 21.4468 27 20.8945V5.89453C27 5.34225 26.5523 4.89453 26 4.89453H6ZM6.00459 7.118C6.00459 6.56571 6.4523 6.118 7.00459 6.118H24.9949C25.5472 6.118 25.9949 6.56571 25.9949 7.118V19.6704C25.9949 20.2227 25.5472 20.6704 24.9949 20.6704H7.00459C6.4523 20.6704 6.00459 20.2227 6.00459 19.6704V7.118Z" fill="#2D65F2" fillOpacity="0.8" />
            <path d="M5.78467 20.8125C5.54687 20.8125 5.33342 20.9584 5.24707 21.18L2.53493 28.1002C2.27786 28.7561 2.76149 29.4651 3.46598 29.4651H28.5434C29.2453 29.4651 29.7288 28.7608 29.4766 28.1057L26.9152 21.4532C26.7665 21.0672 26.3956 20.8125 25.982 20.8125L5.78467 20.8125ZM5.71425 22.9329C5.86452 22.55 6.23384 22.2983 6.64511 22.2983H25.4084C25.8222 22.2983 26.1932 22.5531 26.3418 22.9392L27.7577 26.6198C28.0097 27.2748 27.5262 27.9789 26.8244 27.9789H5.20041C4.4957 27.9789 4.01206 27.2695 4.26955 26.6135L5.71425 22.9329Z" fill="#2D65F2" fillOpacity="0.8" />
            <path d="M20.8518 11.7084C21.0494 11.5042 21.0494 11.1733 20.8518 10.9691C19.5577 9.63132 17.8349 8.89453 16 8.89453C14.1651 8.89453 12.4423 9.63131 11.1482 10.9691C10.9506 11.1733 10.9506 11.5042 11.1482 11.7084C11.2468 11.8104 11.3764 11.8615 11.5059 11.8615C11.6355 11.8615 11.7647 11.8104 11.8637 11.7084C12.9667 10.5682 14.4357 9.94016 16.0003 9.94016C17.5653 9.94016 19.034 10.5683 20.1369 11.7084C20.3342 11.9127 20.6542 11.9127 20.8518 11.7084Z" fill="#2D65F2" fillOpacity="0.8" />
            <path d="M18.7284 13.6791C18.8579 13.6791 18.9872 13.6279 19.0861 13.526C19.2837 13.3217 19.2837 12.9905 19.0861 12.7866C18.2636 11.9366 17.1693 11.4688 16.0039 11.4688C14.8381 11.4688 13.7435 11.9367 12.9216 12.7866C12.724 12.9909 12.724 13.322 12.9216 13.526C13.1192 13.7302 13.4392 13.7302 13.6368 13.526C14.2676 12.8736 15.1084 12.5146 16.0038 12.5146C16.899 12.5146 17.7394 12.8739 18.3708 13.526C18.4694 13.6279 18.599 13.6791 18.7282 13.6791H18.7284Z" fill="#2D65F2" fillOpacity="0.8" />
            <path d="M14.1406 15.9771C14.1406 17.0351 14.9734 17.8959 15.9968 17.8959C17.0202 17.8959 17.853 17.0351 17.853 15.9771C17.853 14.919 17.0202 14.0586 15.9968 14.0586C14.9734 14.0586 14.1406 14.9191 14.1406 15.9771ZM16.8412 15.9771C16.8412 16.4585 16.4625 16.8504 15.9965 16.8504C15.5308 16.8504 15.152 16.4588 15.152 15.9771C15.152 15.4957 15.5308 15.1041 15.9965 15.1041C16.4625 15.1041 16.8412 15.4957 16.8412 15.9771Z" fill="#2D65F2" fillOpacity="0.8" />
        </svg>
    )
}