...
const InstantControlIcon = () => {
    return (
        <svg width="32" height="33" viewBox="0 0 32 33" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M6 4.89453C5.44772 4.89453 5 5.34225 5 5.89453V20.8945C5 21.4468 5.44772 21.8945 6 21.8945H26C26.5523 21.8945 27 21.4468 27 20.8945V5.89453C27 5.34225 26.5523 4.89453 26 4.89453H6ZM6.00459 7.118C6.00459 6.56571 6.4523 6.118 7.00459 6.118H24.9949C25.5472 6.118 25.9949 6.56571 25.9949 7.118V19.6704C25.9949 20.2227 25.5472 20.6704 24.9949 20.6704H7.00459C6.4523 20.6704 6.00459 20.2227 6.00459 19.6704V7.118Z" fill="#2D65F2" fill-opacity="0.8" />
            <path d="M5.78467 20.8125C5.54687 20.8125 5.33342 20.9584 5.24707 21.18L2.53493 28.1002C2.27786 28.7561 2.76149 29.4651 3.46598 29.4651H28.5434C29.2453 29.4651 29.7288 28.7608 29.4766 28.1057L26.9152 21.4532C26.7665 21.0672 26.3956 20.8125 25.982 20.8125L5.78467 20.8125ZM5.71425 22.9329C5.86452 22.55 6.23384 22.2983 6.64511 22.2983H25.4084C25.8222 22.2983 26.1932 22.5531 26.3418 22.9392L27.7577 26.6198C28.0097 27.2748 27.5262 27.9789 26.8244 27.9789H5.20041C4.4957 27.9789 4.01206 27.2695 4.26955 26.6135L5.71425 22.9329Z" fill="#2D65F2" fill-opacity="0.8" />
