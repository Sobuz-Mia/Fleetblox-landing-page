  ...
  const animationItems = [
    {
      ...
      content:
        "Scale your operations effortlessly with a system built for growth. Deploy teams to multiple locations, assign roles with flexible workflows, and maintain unified control—all designed to expand in step with your fleet.",
      image: `/images/industries/a-mobile-scroll-1.svg`,
    },
    {
      title: "Command Operations Across Borders",
      content:
        "Take full control of your day-to-day operations with a centralized dashboard and calendar view. Track progress, manage timelines, and keep your entire team aligned to ensure timely execution, enhanced accountability, and zero delays—no matter where they are.",
      image: `/images/industries/a-mobile-scroll-2.svg`,
    },
    {
      title: "Stay Ahead with Real-Time Coordination",
      content:
        "Maintain seamless communication and responsiveness through in-app messaging. Share updates, issue instructions, and receive instant feedback—ensuring every task moves forward smoothly and your team stays in sync at all times.",
  ...
  const Deals = [
    {
      ...
      content:
        "Easily organize your workforce by location and assign specific roles to streamline operations and team responsibilities.",
          ...
          <div className="w-full lg:flex-1 flex flex-col items-center justify-center gap-y-5 h-full">
            <div className="px-5 lg:px-10 py-8 m-auto w-full max-w-[500px] h-auto lg:h-[160px] flex flex-col lg:flex-row justify-center items-center lg:items-center rounded-[16px] rounded-tl-[60px] shadow-lg bg-white">
              ...
              <div className="lg:ml-5 text-center lg:text-left">
                ...
                <p className="text-[#7d7d7d] text-[16px] leading-6 font-openSans">
                  Keep your dispersed teams in sync and aligned with each other
                  through clear task assignments, shared objectives, and
            ...
            <div className="px-5 lg:px-10 py-8 m-auto w-full max-w-[500px] h-auto lg:h-[160px] flex flex-col lg:flex-row justify-center items-center lg:items-center rounded-[16px]  shadow-lg bg-white">
              ...
              <div className="lg:ml-5 text-center lg:text-left">
                ...
                <p className="text-[#7d7d7d] text-[16px] leading-6 font-openSans">
                  Maximize task scheduling, maintenance, and inspections with
                  smart workflows that reduce manual effort and downtime.
                </p>
              </div>
            </div>
            <div className="px-5 lg:px-10 py-8 m-auto w-full max-w-[500px] h-auto lg:h-[160px] flex flex-col lg:flex-row justify-center items-center lg:items-center rounded-[16px] rounded-br-[60px] shadow-lg bg-white">
              ...
              <div className="lg:ml-5 text-center lg:text-left">
                ...
                <p className="text-[#7d7d7d] text-[16px] leading-6 font-openSans">
                  Make instant task updates, real-time messaging, and shared
                  calendars possible so everyone is up-to-date and responsive.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center justify-center">
            <div className="max-w-[500px] w-full">
              <h3 className="text-[#04082C] leading-[100%] font-bold text-[36px] font-montserrat">
                Empower Every Keep Your Fleet Road-Ready with Remote Inspection
                Assignments
              </h3>
              <p className="text-[#333333] mt-4 text-[16px] leading-[150%] font-openSans text-justify">
                Assign inspection tasks directly to your crew—whether it&apos;s
                a delivery check-in, condition review, or safety check. Results
                upload instantly via the app, enabling fast response and keeping
      ...
      <section className="bg-[#FAFAFF] w-full mt-[60px] lg:mt-[100px] py-12">
        <div className="max-w-[1200px] mx-auto px-5 grid grid-cols-1 lg:grid-cols-2 items-center gap-6 lg:gap-10">
          ...
          <div className="flex items-center justify-center">
            <div className="max-w-[500px] w-full">
              <h3 className="text-[#04082C] leading-[100%] font-bold text-[36px] font-montserrat">
                Run It All Minimize Downtime with Intelligent Maintenance
                Workflow
              </h3>
              <p className="text-[#333333] mt-4 text-[16px] leading-[150%] font-openSans">
                Assign specific repair tasks based on reported issues or
                AI-driven recommendations. Technicians receive clear
                instructions via the app, carry out work on-site, and update
                progress in real time. With integrated chat and live tracking,
                managers stay informed while crews deliver faster, more accurate
                results.
              </p>
            </div>
          </div>
...
const RealTimeCoordination = () => {
  return (
    ...
    >
      <path
        d="M39.7027 0.605469H14.6286C13.3746 0.605469 12.5391 1.44144 12.5391 2.69501V27.7701C12.5391 29.0237 13.375 29.8596 14.6286 29.8596H33.0166L37.8225 36.1283V29.8596H39.912C41.1656 29.8596 42.0015 29.0236 42.0015 27.7701V2.69501C41.7923 1.4414 40.9568 0.605469 39.7028 0.605469H39.7027ZM37.6131 25.6805H16.7177V21.5014H37.6131V25.6805ZM37.6131 17.3223H16.7177V13.1432H37.6131V17.3223ZM37.6131 8.96402H16.7177V4.78494H37.6131V8.96402Z"
        fill="#2D65F2"
        fillOpacity="0.8"
      />
      <path
        d="M8.35825 27.7704V19.4121H2.08954C0.835935 19.4121 0 20.2481 0 21.5016V36.129C0 37.3826 0.835975 38.2186 2.08954 38.2186H4.17908V42.3976L7.31339 38.2186L22.9849 38.2182C24.2385 38.2182 25.0745 37.3822 25.0745 36.1286V34.0391H14.6268C11.0744 34.0391 8.35805 31.3227 8.35805 27.7708L8.35825 27.7704Z"
        fill="#2D65F2"
        fillOpacity="0.8"
      />
    </svg>
