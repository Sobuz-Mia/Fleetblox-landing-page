...
const MaximizeVehicleUptime = () => {
  return (
   <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M39.5746 39.5564C35.416 43.71 29.8854 45.9989 24.002 45.9989C19.2267 45.9989 14.6988 44.469 10.9333 41.6805V44.5335C10.9333 45.3443 10.2758 46 9.46533 46C8.65445 46 7.99732 45.3439 7.99732 44.5335V38.5193C7.99732 37.7085 8.65483 37.0528 9.46533 37.0528H15.4857C16.2966 37.0528 16.9537 37.7089 16.9537 38.5193C16.9537 39.33 16.2962 39.9858 15.4857 39.9858H13.6057C21.0005 44.7856 31.0173 43.9548 37.4975 37.4821C43.4247 31.5596 44.7811 22.2851 40.7953 14.9275C40.4095 14.2157 40.674 13.3262 41.3876 12.9394C42.1008 12.5555 42.9904 12.8175 43.3776 13.5326C47.9773 22.0217 46.4128 32.7224 39.5739 39.5565L39.5746 39.5564ZM10.5016 10.5179C14.1054 6.9185 18.8985 4.9345 23.9983 4.9345C27.7478 4.9345 31.3271 6.01598 34.3943 8.01386H32.5146C31.7038 8.01386 31.0466 8.66998 31.0466 9.48037C31.0466 10.2911 31.7042 10.9469 32.5146 10.9469H38.5351C39.3459 10.9469 40.0031 10.2908 40.0031 9.48037V3.46651C40.0031 2.65574 39.3455 2 38.5351 2C37.7242 2 37.067 2.65612 37.067 3.46651V6.32387C28.4527 -0.0357053 16.2256 0.653577 8.42675 8.44398C1.58673 15.2776 0.0225734 25.9783 4.623 34.466C4.88892 34.9573 5.3938 35.2353 5.91541 35.2353C6.15109 35.2353 6.3908 35.1782 6.613 35.0592C7.32625 34.6724 7.59068 33.783 7.20532 33.0712C3.21906 25.7145 4.57489 16.4405 10.5027 10.5174L10.5016 10.5179Z" fill="#2D65F2" fill-opacity="0.5"/>
<path d="M28.3042 15.8461C28.3042 15.1413 29.0147 14.6634 29.6196 15.0251C31.0887 15.9036 32.3027 17.204 33.0738 18.8081L33.494 19.6822C33.6057 19.9146 33.8407 20.0623 34.0985 20.0623C37.4321 20.0623 40.1345 22.7646 40.1345 26.0981V27.9117C40.1345 28.3934 39.744 28.7838 39.2623 28.7838H9.10348C8.4207 28.7838 7.86719 28.2304 7.86719 27.5476V22.8439C7.86719 21.3077 9.11258 20.0623 10.6489 20.0623H11.3374C11.8127 20.0623 12.2458 19.79 12.4517 19.3617L12.7178 18.8081C13.4413 17.3031 14.5546 16.0654 15.9027 15.1927C16.5052 14.8027 17.2389 15.2789 17.2389 15.9966V18.6812C17.2389 19.3602 17.7894 19.9106 18.4684 19.9106H27.0747C27.7538 19.9106 28.3042 19.3602 28.3042 18.6812V15.8461Z" fill="#B8CBFC"/>
<path d="M16.5711 22.3086C15.4708 22.3086 14.3952 22.6349 13.4803 23.2461C12.5654 23.8574 11.8524 24.7263 11.4313 25.7428C11.0102 26.7593 11.0002 27.8779 11.1147 28.957C11.3294 30.0361 11.8592 31.0274 12.6373 31.8054C13.4153 32.5834 14.4066 33.1133 15.4858 33.3279C16.565 33.5426 17.6836 33.4324 18.7001 33.0113C19.7167 32.5903 20.5856 31.8772 21.1969 30.9624C21.8082 30.0475 22.1345 28.972 22.1345 27.8717H18.7965C18.7965 28.3118 18.666 28.742 18.4214 29.108C18.1769 29.4739 17.8294 29.7591 17.4227 29.9276C17.0161 30.096 16.5687 30.14 16.137 30.0542C15.7053 29.9683 15.3088 29.7564 14.9976 29.4452C14.6864 29.134 14.4744 28.7375 14.3886 28.3058C14.3027 27.8742 14.3468 27.4267 14.5152 27.0201C14.6836 26.6135 14.9689 26.266 15.3348 26.0215C15.7008 25.777 16.131 25.6465 16.5711 25.6465V22.3086Z" fill="#2D65F2" fill-opacity="0.5"/>
<path d="M26.3281 27.8717C26.3281 26.7714 26.6544 25.6958 27.2657 24.781C27.877 23.8662 28.7459 23.1531 29.7625 22.7321C30.779 22.311 31.8976 22.2008 32.9768 22.4155C34.056 22.6301 35.0473 23.16 35.8253 23.938C36.6034 24.716 37.1332 25.7073 37.3479 26.7864C37.5626 27.8655 37.4524 28.9841 37.0313 30.0006C36.6102 31.0171 35.8972 31.886 34.9823 32.4972C34.0674 33.1085 32.9918 33.4348 31.8915 33.4348L31.8915 30.0969C32.3316 30.0969 32.7618 29.9664 33.1278 29.7219C33.4937 29.4774 33.779 29.1299 33.9474 28.7233C34.1158 28.3167 34.1599 27.8692 34.074 27.4376C33.9882 27.0059 33.7762 26.6094 33.465 26.2982C33.1538 25.987 32.7573 25.7751 32.3256 25.6892C31.8939 25.6034 31.4465 25.6474 31.0399 25.8158C30.6332 25.9843 30.2857 26.2695 30.0412 26.6354C29.7966 27.0014 29.6661 27.4316 29.6661 27.8717L26.3281 27.8717Z" fill="#2D65F2" fill-opacity="0.5"/>
</svg>
    ...
    <div>
      ...
      <section className="bg-[#FAFAFF] pt-[100px] lg:pt-[140px] pb-[30px] ">
        <div className="lg:max-w-[calc(100vw-30px)] xxl:max-w-[1440px] mx-auto w-full flex flex-col px-5 lg:flex-row items-center justify-between">
          <div className="lg:pl-[100px] max-w-[660px] w-full">
            ...
            Fleetblox Remote Operations gives you the power to manage your entire operation remotely—ensuring business continuity and complete control, no matter where your vehicles or teams are located.
            </p>
            <Link
      ...
      {/* remote diagnostics section */}
       <section className="max-w-[1200px] mx-auto w-full py-[120px] px-5">
        <div className="max-w-[840px] mx-auto w-full md:text-center mb-[60px]">
          ...
          <p className="text-[#333] text-[16px] leading-6 font-openSans ">
          Replace Traditional Checks with Automated, Interactive Diagnostics from Anywhere
          </p>
        </div>
      ...
      <section className="max-w-[1200px] mx-auto w-full py-[120px] px-5">
        <div className="max-w-[840px] mx-auto w-full md:text-center mb-[60px]">
          ...
          <p className="text-[#333] text-[16px] leading-6 font-openSans ">
          Remote coordination across locations with intelligent assignments, tasks and crew management.
          </p>
        </div>
