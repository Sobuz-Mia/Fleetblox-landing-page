...
const AboutUsPage = () => {
    ...
    return (
        <>
            ...
            <section className=" pt-[60px] sm:pt-[80px] md:pt-[100px] pb-[20px] sm:pb-[30px] overflow-hidden relative">
                <div className="max-w-[1200px] mx-auto px-4 sm:px-5 flex flex-col items-center py-[60px] sm:py-[80px] md:py-[100px] lg:py-[120px] text-center relative z-50">
                    <h5 className="text-[20px] sm:text-[24px] md:text-[28px] text-[#0336BC] font-bold font-montserrat">
                        Our Moto
                    </h5>
                    <h2 className="text-[26px] sm:text-[26px] md:text-[32px] lg:text-[36px] font-bold text-[#04082C] leading-tight md:leading-[1.1] max-w-[800px] w-full mx-auto mb-[8px] sm:mb-[10px] mt-[5px] font-montserrat">
            ...
            <GlobeSection
                ...
                description="Fleetblox is designed for today's automotive transformation , helping businesses adapt to fast-changing market conditions - and simplifying 
growth to make scaling smarter."
            />
            {/* FAQS */}
            ...
            {/* Footer Call to Action section */}
            <section className="bg-[#FAFAFF] py-12 sm:py-16 md:py-20">
                <div className="max-w-[1200px] mx-auto px-4 sm:px-5 text-center">
                    ...
                    <p className="text-sm sm:text-base text-[#7D7D7D] mb-6">
